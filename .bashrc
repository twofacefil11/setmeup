...
if [ "$color_prompt" = yes ]; then
   ...
   # PS1='\[\e[38;5;202m\]\u\[\e[0m\] : \[\e[38;5;109m\]$(for ((i = 1; i < $(echo "$PWD" | tr -cd '/' | wc -c); i++)); do echo -n "/"; done)\W\[\e[0m\] : '
...
alias nclcp="netcat -l -p 44666 | clip.exe"
alias ncl="netcat -l -p 44666"
