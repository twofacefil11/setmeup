...
mkdir -pv $alacritty_path $zellij_path $yazi_path $keyd_path
...
//
// THIS FILE WAS AUTOGENERATED BY ZELLIJ, THE PREVIOUS FILE AT THIS LOCATION WAS COPIED TO: /home/twofa/.config/zellij/config.kdl.bak
//
...
echo "writting configs"
  ...
  echo "  -keyd"
    echo "$keyd_config" > "$keyd_config/default.conf"

echo "gitting stuff over here"
  
  echo "yazi flavor (kanagawa)"
    git clone https://github.com/dangooddd/kanagawa.yazi.git $yazi_path/flavors
  echo "font: GohuFont uni 14 Nerd Font Mono"
